...
namespace Story
{
    class Program
    {
        private static void Title()
        {
            ...
            Console.WriteLine("\t|_______________________|");
            Console.WriteLine();
            Console.Write("If you want to start reading click or exit (enter/esc): ");
        ...
        private static void Text()
        {
            ...
            Thread.Sleep(1500);
            Console.WriteLine($"\t\tЯ — Великий Умывальник, Знаменитый {washbasin.ToString_2()},");
            Thread.Sleep(1500);
            ...
            Thread.Sleep(1500);
            Console.WriteLine($"\t\tИ тебе головомойку, {washbasin.ToString3()}, дадут —");
            Thread.Sleep(1500);
            ...
            Thread.Sleep(1500);
            Console.WriteLine($"\t\tИ вскричал: «{washbasin.ToString4()}!»");
            Thread.Sleep(1500);
            ...
            Console.WriteLine($"\t\tТут Великий {washbasin.ToString_2()}");
            Thread.Sleep(1500);
